                            ...
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fname" placeholder="Account Name" name="fname" value="<?php echo $name; ?>" maxlength="128">
...
<script src="<?php echo base_url(); ?>assets/js/editaccount.js" type="text/javascript"></script>